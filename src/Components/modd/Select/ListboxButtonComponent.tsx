...
>(({ open, selectedOption }, ref) => (
  <ListboxButton
    ref={ref}
    data-open={open}
    tw="mx-1 mb-4 mt-8 flex h-[38px] min-w-[180px] text-sm items-center rounded-md border border-gray-300 bg-white px-2 py-2 font-bold focus-visible:outline-none focus-visible:ring-2 data-[focus]:border-gray-300 data-[active]:ring-2 data-[focus]:ring-2"
  >
